...
def default_rule(p4info_helper, sw): 
    table_entry = p4info_helper.buildTableEntry(
        table_name="MyIngress.ipv4_lpm",
        default_action=True,
...
def writeTunnelRules(p4info_helper, ingress_sw, egress_sw, port,
...
def main(p4info_file_path, bmv2_file_path):
    ...
    try:
        ...
        default_rule(p4info_helper, sw=s1)
        ...
        default_rule(p4info_helper, sw=s2)
        ...
        default_rule(p4info_helper, sw=s3)
